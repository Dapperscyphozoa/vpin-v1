...
STRATEGY_PARAMS = {
    ...
    "vpin_window": int(os.environ.get("STRATEGY_VPIN_WINDOW", "50")),
    "vpin_threshold": float(os.environ.get("STRATEGY_VPIN_THRESHOLD", "0.55")),
    "swing_lookback": int(os.environ.get("STRATEGY_SWING_LOOKBACK", "24")),
    "extreme_proximity_pct": float(os.environ.get("STRATEGY_EXTREME_PROXIMITY_PCT", "0.005")),
    # fork keys above
}
